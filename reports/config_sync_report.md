...
| `config_preset_mode` | `preset_and_basic` | `services/config_preset.py:110` |
| `debug_injection` | `preset_and_basic` | `core/memory_manager.py:1672`, `main.py:235` |
...
| `enable_keyword_boost` | `retrieval_ranking` | `core/memory_manager.py:1623` |
| `enable_memory_context_hint` | `retrieval_ranking` | `core/memory_manager.py:1375`, `core/memory_manager.py:1625` |
| `enable_memory_decay` | `decay` | `core/memory_manager.py:1624`, `core/scheduler.py:705` |
...
| `enable_ngram_keyword_rank` | `retrieval_ranking` | `core/memory_manager.py:1692` |
...
| `keyword_boost_weight` | `retrieval_ranking` | `core/memory_manager.py:1637` |
...
| `max_recent_memories` | `retrieval_ranking` | `core/memory_manager.py:1529` |
| `memory_context_window` | `retrieval_ranking` | `core/memory_manager.py:1377`, `core/memory_manager.py:1627` |
...
| `memory_query_max_results` | `retrieval_ranking` | `core/memory_manager.py:1286`, `core/memory_manager.py:1594` |
| `memory_reinforce_bonus` | `decay` | `core/memory_manager.py:1494`, `core/memory_manager.py:2003` |
| `memory_search_tool_max_results` | `tool_search` | `handlers/tool_commands.py:46` |
| `memory_similarity_threshold` | `retrieval_ranking` | `core/memory_manager.py:1621` |
...
| `monthly_folding_model` | `folding` | `core/memory_manager.py:0` |
| `monthly_folding_prompt` | `folding` | `core/memory_manager.py:1227` |
...
| `rank_recency_half_life_days` | `retrieval_ranking` | `core/memory_manager.py:1779` |
| `rank_strategy` | `retrieval_ranking` | `core/memory_manager.py:1632` |
| `rank_weight_activity` | `retrieval_ranking` | `core/memory_manager.py:1649` |
| `rank_weight_keyword` | `retrieval_ranking` | `core/memory_manager.py:1647` |
| `rank_weight_recency` | `retrieval_ranking` | `core/memory_manager.py:1648` |
| `rank_weight_vector` | `retrieval_ranking` | `core/memory_manager.py:1646` |
| `show_relevance_score` | `retrieval_ranking` | `core/memory_manager.py:1374`, `core/memory_manager.py:1622` |
...
| `weekly_folding_model` | `folding` | `core/memory_manager.py:0` |
| `weekly_folding_prompt` | `folding` | `core/memory_manager.py:1204` |
...
| `yearly_folding_model` | `folding` | `core/memory_manager.py:0` |
| `yearly_folding_month` | `folding` | `core/scheduler.py:470` |
| `yearly_folding_prompt` | `folding` | `core/memory_manager.py:1251` |
