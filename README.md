...
- [模块详细设计文档](./docs/模块详细设计文档.md)
- [数据库设计文档](./docs/数据库设计文档.md)
- [主流程时序文档](./docs/主流程时序文档.md)
- [WebUI接口文档](./docs/WebUI接口文档.md)
- [私聊记忆设计文档](./docs/私聊记忆设计文档.md)
- [群聊记忆设计文档](./docs/群聊记忆设计文档.md)
- [配置项说明文档](./docs/配置项说明文档.md)
- [画像系统设计文档](./docs/画像系统设计文档.md)
...
> WebUI 群聊记忆页面现已支持默认展示全部群聊记忆，并可按群组、关键词、日期继续筛选。
...
在 Python 3.13 环境下，`chromadb` 相关依赖可能因本地缺少编译工具链而无法安装。
当前版本已做兼容处理：
