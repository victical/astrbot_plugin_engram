...
**改造任务**
- [x] 枚举 schema 配置项与代码读取点（已新增自动核对脚本）
- [ ] 未使用项：实现或删除（并写迁移说明）
- [ ] 补充配置读取单测

**验收标准**
- [ ] 配置项与读取点一一对应（当前报告：schema=88, code=79, schema_only=9）
- [x] 文档与行为一致（README 已补脚本使用说明）

**进度记录**
- 完成日期：
- 负责人：
- Commit/PR：
- 备注：新增 `tools/check_config_sync.py` 与 `reports/config_sync_report.md` 自动核对清单。
